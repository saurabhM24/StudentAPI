package com.saurabhm.demo.service;

import com.saurabhm.demo.dao.StudentDao;
...
public class StudentService {
    ...
    public int updateStudentById(UUID studentId, Student studentUpdate) {
        //Here we can add logic which will check if the student already exists. Otherwise fail with error.
